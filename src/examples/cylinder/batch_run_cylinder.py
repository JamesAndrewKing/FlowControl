...
# eng.load('lqr_controller_workspace_augmented.mat', nargout=0)
...
def run_lidcavity_with_ic(Re, xloc, yloc, radius, amplitude, u_ctrl_const, save_dir, num_steps=100):
    # LOG
    ...
    for _ in range(fs.params_time.num_steps):
        ...
        # u_ctrl = eng.lqr_controller_matlab_augmented(
...
def main():
    ...
    parent_dir = base_dir / f"Re{Re}_lqr_augmented"
    ...
    for u_ctrl_const in u_ctrl_const_vals:
        for xloc in x_vals:
            for yloc in y_vals:
                ...
                print(f"Running simulation {count} with xloc={xloc:.3f}, yloc={yloc:.3f}, radius={radius:.3f}, amplitude={amplitude:.3f}, u_ctrl={u_ctrl_const:.3f}")
